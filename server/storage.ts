...
export class JsonStorage implements IStorage {
  ...
  private getDefaultData(): AppData {
    ...
    const privileges: Privilege[] = [
      ...
      // SCM - Procurement
      { id: "P_SCM_PROC_01", module: "SCM", function: "Procurement", role: "Manage sourcing events such as RFQs, RFPs, and auctions" },
      { id: "P_SCM_PROC_02", module: "SCM", function: "Procurement", role: "Review, approve, and amend purchase orders" },
      { id: "P_SCM_PROC_03", module: "SCM", function: "Procurement", role: "Track procurement cycle times and supplier performance" },
      { id: "P_SCM_PROC_04", module: "SCM", function: "Procurement", role: "Run procurement reports and spend analysis" },
