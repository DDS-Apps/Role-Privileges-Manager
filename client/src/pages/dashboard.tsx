  ...
  return (
    <div className="min-h-screen bg-background font-sans">
      ...
      <main className="mx-auto max-w-7xl p-4 md:p-6 space-y-6">
        ...
        {actingUser && (
          <div className="flex rounded-lg border border-border bg-slate-200 dark:bg-slate-800 overflow-hidden">
            {/* Left Gradient Strip */}
        ...
        {actingUser && (
          <div className="rounded-lg border border-border bg-slate-200 dark:bg-slate-800 p-4">
